...
namespace TradeIt.Charts
{
    public partial class ChartTabView
    {
        ...
        // Keep the class-level arrow input fix. It is drawing input, not chart zoom.
        private static readonly bool _arrowInputRegistered = RegisterArrowInput();

        private static bool RegisterArrowInput()
        {
            EventManager.RegisterClassHandler(
                typeof(ChartTabView),
                UIElement.PreviewMouseLeftButtonDownEvent,
                new System.Windows.Input.MouseButtonEventHandler(ArrowInput_ClassMouseDown));
            return true;
        }

        private static void ArrowInput_ClassMouseDown(object sender, System.Windows.Input.MouseButtonEventArgs e)
        {
