...
namespace TradeIt
{
    public partial class MainWindow
    {
        ...
        private async Task StartOrder2AutoScrollAsync()
        {
            ...
            int selectedIndex = -1;
            if (SymbolsDataGrid.SelectedItem is SymbolInfo selected)
                selectedIndex = _allSymbols.IndexOf(selected);
            ...
            _order2AutoScrollTimer = new DispatcherTimer
            {
        ...
        {
            if (!_order2AutoScrollRunning || _order2AutoScrollLoading)
                return;
        ...
        private async Task ShowOrder2AutoScrollSymbolAsync()
        {
            if (!_order2AutoScrollRunning || _order2AutoScrollLoading ||
                ...
                _order2AutoScrollIndex >= _allSymbols.Count)
                return;
            ...
            try
            {
                ...
                _order2AutoScrollTab.Header = $"{symbol.DisplayName} — Auto Scroll";
                ChartTabs.SelectedItem = _order2AutoScrollTab;
